                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                      ...
                      <div style="margin-bottom: 15px">
                        <div class="col-md-3 none-padding">
                          <div class="checkbox">
                              <label><input type="checkbox" name="is_fbshare" value="1" <?php echo e(old('is_fbshare') == 1 ? "checked" : ""); ?>> Share FB giảm giá </label>
                          </div>                          
                        </div>
                        <div class="col-md-9">                          
                          <label>Giá sau share FB</label>                  
                          <input type="text" class="form-control number" name="price_share" id="price_share" value="<?php echo e(old('price_share')); ?>">                                                                     
                        </div>  
                        <div class="clearfix"></div>
          </div>
                         <div style="margin-bottom: 15px">                 
