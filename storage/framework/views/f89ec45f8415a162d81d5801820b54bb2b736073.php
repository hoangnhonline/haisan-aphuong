          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <?php endif; ?>
                <td>
                  <img class="img-thumbnail lazy" width="80" data-original="<?php echo e($item->image_url ? Helper::showImageThumb($item->image_url) : URL::asset('public/admin/dist/img/no-image.jpg')); ?>" alt="<?php echo e($item->name); ?>" title="<?php echo e($item->name); ?>" />
                </td>
                <td>                  
                ...
                <td style="white-space:nowrap; text-align:right">
                  ...
                  <a onclick="return callDelete('','<?php echo e(route( 'product.destroy', [ 'id' => $item->id ])); ?>');" class="btn btn-danger btn-sm">Xóa</a>
