...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <button id="btnExport" data-link="<?php echo e(route('orders.export')); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px">Xuất Excel</button>
          ...
          <table class="table table-bordered" id="table-list-data">           
            ...
            <tbody>
              ...
              <?php $i = 0; ?>
                ...
                <?php endif; ?>
                <?php if($order->notes): ?>
                <br><p style="color:red;margin-top: 10px;"><u>Ghi chú: </u><i><?php echo e($order->notes); ?></i></p>
                <?php endif; ?>
                </td>
                             
                <td style="text-align:right;width:100px"><strong style="font-size: 17px"><?php echo e(number_format($order->total_payment)); ?></strong>
                  <br>
                  <div class="form-group form-inline">
                    <label>Phí ship</label>
                    <input type="text" name="" value="<?php echo e(number_format($order->shipping_fee)); ?>" class="phiship number" data-id="<?php echo e($order->id); ?>" class="form-control" data-status="<?php echo e($order->status); ?>" data-customer="<?php echo e($order->customer_id); ?>" style="text-align: right;padding-right: 5px;margin-top: 10px;width: 80px">
                </div>
                </td>
                <td>
