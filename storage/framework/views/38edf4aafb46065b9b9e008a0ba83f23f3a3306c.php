...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
        <a href="<?php echo e(route('newsletter.export')); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px">Xuất Excel</a>
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="white-space:nowrap">                  
                  <a href="<?php echo e(route( 'newsletter.edit', [ 'id' => $item->id ])); ?>" class="btn btn-warning btn-sm">Chỉnh sửa</a>                 
                  
                  <a onclick="return callDelete('<?php echo e($item->email); ?>','<?php echo e(route( 'newsletter.destroy', [ 'id' => $item->id ])); ?>');" class="btn btn-danger  btn-sm">Xóa</a>
